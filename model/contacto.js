...
contacto.selectAll = function(idUsuario, callback) {
  if(database) {
    database.query("SELECT contacto.idContacto, contacto.nombre, contacto.apellido, contacto.correo, contacto.telefono, categoria.nombre as 'categoria' FROM contacto INNER JOIN categoria ON (contacto.idCategoria = categoria.idCategoria)",
    idUsuario,
